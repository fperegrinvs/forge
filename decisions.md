...
- Desktop Packs tab now visualizes a selected pack's workflow phases/gates and allows binding per-phase validation scripts via a native file picker; bindings persist per project in `.forge/phase-gates.json`.
